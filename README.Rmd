...
```
Each of the 1-cumulative escape probability can be thought of as the detection probability - which only reaches around 0.25 after 2 weeks in this example.
